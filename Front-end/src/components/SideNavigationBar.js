...
const SideNavigation = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "side-nav-bar__logo", onClick: handleToggleMenu, children: _jsx("i", { className: "fas fa-sliders" }) }), _jsx("div", { className: "side-nav-bar__search-link", children: _jsx("i", { className: "fas fa-magnifying-glass", onClick: handleSearchNavigation }) }), _jsx("div", { className: `side-nav-bar ${isMenuActive ? "active" : "hidden"}`, children: _jsx("div", { className: "side-nav-bar__icon", children: !currentUser ? (
                    /* Admin control icons */
                    _jsxs("div", { children: [_jsx("i", { className: "fas fa-house", onClick: handleHomeNavigation }), _jsx("i", { className: "fas fa-magnifying-glass", onClick: handleSearchNavigation }), _jsx("span", { className: "side-nav-bar__login", children: _jsx("i", { className: "fas fa-arrow-right-from-bracket", onClick: handleLoginOrAddAdmin }) })] })) : (_jsxs("div", { children: [_jsxs("div", { className: "side-nav-bar__admin-control", children: [_jsx("i", { className: "fas fa-house", onClick: handleHomeNavigation }), _jsx("i", { className: "fas fa-user-plus", onClick: handleLoginOrAddAdmin }), _jsx("i", { className: "fas fa-magnifying-glass", onClick: handleSearchNavigation }), _jsx("i", { className: "as fa-location-arrow", onClick: handleCoordinates }), _jsx("i", { className: "fas fa-heart-circle-xmark", onClick: handleDeleteAllSongsNavigation, title: "Delete All Songs" }), _jsx("i", { className: "fas fa-music", onClick: handlePlaylistNavigation })] }), _jsx("br", {}), _jsxs("div", { className: "side-nav-bar__media-control", children: [_jsx("i", { className: "fas fa-circle-pause" }), _jsx("i", { className: "fas fa-forward-step" })] }), _jsx("span", { className: "side-nav-bar__logout", children: _jsx("i", { className: "fas fa-arrow-right-from-bracket fa-rotate-180" }) })] })) }) }), _jsx(SearchModal, { isOpen: isModalOpen, onClose: handleCloseModal })] }));
};
