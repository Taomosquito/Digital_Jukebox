...
const SideNavigation = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "side-nav-bar__logo", "data-testid": "nav-button", onClick: handleToggleMenu, children: _jsx("i", { className: "fas fa-sliders" }) }), _jsx("div", { "data-testid": "search-button", className: "side-nav-bar__search-link", onClick: () => {
                    handleSearchClick(); // Open the search modal
                    handleCloseSideNav(); // and close the side navigation
                }, children: _jsx("i", { className: "fas fa-magnifying-glass" }) }), _jsx("div", { className: `side-nav-bar ${isMenuActive ? "active" : "hidden"}`, "data-testid": "user-button-parent", children: _jsxs("div", { className: "side-nav-bar__icon", children: [_jsxs("div", { className: "side-nav-bar__admin-control", "data-testid": "user-button", children: [_jsx("i", { className: "fas fa-house" }), _jsx("i", { className: "fas fa-user-plus" }), _jsx("i", { className: "fas fa-magnifying-glass", onClick: () => {
                                        handleSearchClick();
